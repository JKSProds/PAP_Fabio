...
namespace PAP_Fabio.Controllers
{
    public class Compras : Controller
    {
        ...
        public IActionResult ListaCompras(string filter, int? page, int ID)
        {
            ...
            return View(context.ObterCompras(ID).Where(c => c.NomeProd.Contains(filter)));
